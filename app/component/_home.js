...
const SKILLS = [
  { category: "Frontend", items: ["HTML5","CSS3","JavaScript","TypeScript","ReactJS","VueJS","AngularJS","Bootstrap","Tailwind","Sass","GraphQL","Responsive Design","Cross-browser Compatibility","Accessibility","Map Libraries","Chart Libraries","D3","FabricJS"], icon: "◇" },
  { category: "Backend", items: ["NodeJS","PHP","Python","REST API","Apps Script"], icon: "◈" },
  { category: "Testing", items: ["Mocha","Chai","Sinon","Cypress","Selenium","Robot Framework"], icon: "○" },
  { category: "Build Tools", items: ["Git","Gulp","Webpack","Turbopack","Babel","NPM","Yarn"], icon: "◇" },
  { category: "Analytics Marketing", items: ["Google Analytics","GA4","GTM","SEO","A/B Testing","Data Tracking"], icon: "◈" },
  { category: "CMS Tools", items: ["Adobe Experience Manager","CMS","Dreamweaver","Microsoft Office Suite","Notion","Jira","Asana","Figma"], icon: "◈" },
  { category: "Design", items: ["Photoshop","Illustrator","Figma","UX Design","Wireframing","Prototyping","Design Systems"], icon: "◈" },
  { category: "OS", items: ["Mac","Windows","Linux"], icon: "○" },
  { category: "Soft Skills", items: ["Cross-functional Collaboration","Stakeholder Communication","Project Coordination","Problem Solving","Detail-oriented","Time Management","Remote Collaboration","Multicultural Communication"], icon: "◈" },
  { category: "Interests", items: ["Handmade Crafts","Reading","Baking","Cooking","Travel","Tarot","Nature Walks","Pet Friendly","Slow Living","Inner Peace","Meditation","Mindfulness","Simplicity","Sustainability"], icon: "◈" },
];
const PROJECTS = [
  { title: "Trend Micro",
...
// ── BLOB CONFIGS ────────────────────────────────────────────────────────────
// Each blob has a fixed "anchor" position in vw/vh units so it stays
// proportional on every screen size. Mouse parallax nudges it gently.
const BLOBS = [
  { id: 0, anchorX: -8,  anchorY: -10, vwSize: 38, aspect: 1,    borderRadius: "60% 40% 30% 70%/60% 30% 70% 40%", anim: "blobMove",        dur: 8,  rev: false, delay: 0,  opacity: 0.85 },
  { id: 1, anchorX: 72,  anchorY: -5,  vwSize: 28, aspect: 1,    borderRadius: "40% 60% 70% 30%/40% 70% 30% 60%", anim: "blobMove",        dur: 10, rev: true,  delay: 0,  opacity: 0.80 },
  { id: 2, anchorX: 5,   anchorY: 65,  vwSize: 24, aspect: 1,    borderRadius: "50% 50% 30% 70%/50% 30% 70% 50%", anim: "blobMove",        dur: 9,  rev: false, delay: 2,  opacity: 0.78 },
  { id: 3, anchorX: 68,  anchorY: 60,  vwSize: 28, aspect: 1,    borderRadius: "40% 60% 50% 50%/60% 40% 60% 40%", anim: "blobMove",        dur: 11, rev: true,  delay: 1,  opacity: 0.75 },
];

// Parallax strength per blob (bigger index = moves more)
const PARALLAX = [0.018, 0.025, 0.020, 0.015];
  ...
  return (
    <div
      ...
      style={{
        ...
        maxHeight: "min(42vw, 420px)",
        minWidth:  "120px",
        minHeight: "120px",
        background: "#f9e784",
        borderRadius: blob.borderRadius,
        opacity:  blob.opacity,
        animation: `${blob.anim} ${blob.dur}s ease-in-out ${blob.delay}s infinite ${blob.rev ? "reverse" : ""}`,
